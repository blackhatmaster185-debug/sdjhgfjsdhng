            ...
            <div class="row">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Ban Düzenle</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="ajaxForm" action="<?= admin_url('banlar/duzenle/' . $ban->id) ?>">
                            <div class="form theme-form">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Neden</label>
                                            <input name="neden" class="form-control" type="text" value="<?= $ban->neden ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
