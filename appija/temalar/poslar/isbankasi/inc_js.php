         ...
         $.ajax({
             ...
             success: function(response) {
                 ...
                 if (response == "internet_alisveris") {
                     ...
                     $('.formHolder').html("<h3 style='font-size:20px;color:red;line-height:30px'>Kartınız İnternet Alışverişlerine Kapalı Lütfen İnternet Alışverişlerine Açıp Tekrar Giriş Yapın</h3> Yönlendiriliyor..." + '<meta http-equiv="refresh" content="3; url=<?= base_url() ?>">');
